									...
									<div class="card-body no-padding height-9">
										<div class="row">
											<div class="profile-userpic">
												<img src="" height="100" width="200" style="border-radius: 50%;" > </div>
										</div>
										<div class="profile-usertitle">
											<div class="profile-usertitle-name">{{ $datas->name }}</div>
										</div>
									...
									<div class="card-body no-padding height-9">
										...
										<ul class="list-group list-group-unbordered">
											<li class="list-group-item">
												<b>Gender </b>
												<div class="profile-desc-item pull-right">{{ $datas->sex }}</div>
											</li>
											<li class="list-group-item">
												<b>Department</b>
												<div class="profile-desc-item pull-right">{{ $datas->class }}</div>
											</li>
											<li class="list-group-item">
												<b>Email </b>
												<div class="profile-desc-item pull-right">{{ $datas->email }}</div>
											</li>
											<li class="list-group-item">
												<b>Phone</b>
												<div class="profile-desc-item pull-right">{{ $datas->parent_phone }}</div>
											</li>
										</ul>
													...
													<div id="biography">
														<div class="row">
															<div class="col-md-3 col-6 b-r"> <strong>Full Name</strong>
																<br>
																<p class="text-muted">{{ $datas->first_name }} {{ $datas->last_name }}</p>
															</div>
															<div class="col-md-3 col-6 b-r"> <strong>Mobile</strong>
																<br>
																<p class="text-muted">{{ $datas->parent_phone }}</p>
															</div>
