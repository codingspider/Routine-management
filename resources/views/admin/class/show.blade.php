...
<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle"
 id="example4">
	...
	<tbody>
		...
		@foreach($onestudents as $student)
		<tr class="odd gradeX">
			<td class="patient-img">
				<img src="{{URL::to($student->photo)}}" height="100" width="200" style="border-radius: 50%;" >
			</td>
			<td class="left">{{ $student->roll }}</td>
			<td>{{ $student->first_name }} {{ $student->first_name }}</td>
			<td class="left">{{ $student->father_name }}</td>
