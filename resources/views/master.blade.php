  ...
  <body>
    ...
    <div class="br-sideleft sideleft-scrollbar">
      ...
      <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
          <li class="br-menu-item">
          <a href="{{ URL::to('/teacher/create') }}" class="br-menu-link ">
            <i class="menu-item-icon icon fa fa-user tx-24"></i>
            <span class="menu-item-label">Add Teacher</span>
          </a><!-- br-menu-link -->
        </li><!-- br-menu-item -->
        <li class="br-menu-item">
          <a href="{{ URL::to('/student/create') }}" class="br-menu-link ">
            <i class="menu-item-icon icon fa fa-user tx-24"></i>
            <span class="menu-item-label">Add Student</span>
          </a><!-- br-menu-link -->
        </li>
        <li class="br-menu-item">
          <a href="{{ URL::to('/subject/create')}}" class="br-menu-link ">
            <i class="menu-item-icon icon fa fa-book tx-24"></i>
            <span class="menu-item-label">Add Subject</span>
          </a><!-- br-menu-link -->
        </li>
          <li class="br-menu-item">
          <a href="{{ URL::to('/routine/create') }}" class="br-menu-link ">
            <i class="menu-item-icon icon fa fa-book tx-24"></i>
            <span class="menu-item-label">Add Routine</span>
          </a><!-- br-menu-link -->
        </li>
        

            <li class="br-menu-item">
          <a href="{{ URL::to('/routine/view') }}" class="br-menu-link ">
            <i class="menu-item-icon icon fa fa-book tx-24"></i>
            <span class="menu-item-label">View Routine</span>
          </a><!-- br-menu-link -->
        </li>
      
        <li class="br-menu-item">
          <a href="{{ URL::to('/routine/my/view') }}" class="br-menu-link ">
            <i class="menu-item-icon icon fa fa-book tx-24"></i>
            <span class="menu-item-label">My Routine</span>
          </a><!-- br-menu-link -->
        </li>
